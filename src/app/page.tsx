        ...
        <div className="w-2/6 border-r border-solid pe-4">
          <div className="divide-y divide-gray-100">
            {recentFiles.map((recent, i) => (
              <Link href={`/explore?path=${"/Users/mattalui/Development/projects/mattadata/fake-shared/a/mid.txt"}`} className="flex justify-between gap-x-6 py-5 hover:bg-gray-50">
